...
// Global var to cache info about indicators for easy access. 
	...
	$(window).load(function(){
	  ...
	  $articles.each(function(i) {
	    ...
	    var margins = 'margin: ' + ((i*1.5)+4) + 'em 0 ' + ((iInverse*1.5)+5) + 'em 0;'; 
	    rawIndicators +=  '<a class="indicator indicator--upcoming" style="' + margins + '" href="#' + this.id + '"><span class="indicator-tooltip">' + $(this).find("h3").text() + '</span></a>';
	  });
	  ...
	  var initIndicators = function() {
	    ...
	    setTimeout(function(){
	      ...
	      $(indicators).each(function(){
	        ...
	        if(dst>=this.viewableTopStop && dst<=(this.viewableBottomStop))
	  ...
	  var adjustIndicators = function() {
	    ...
	    var anticipated = _.filter(indicators, function(o) { return (dst<=o.absPos && dst>=(-1*o.absBottomStop)) });
